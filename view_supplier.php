...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>PDV Web - Fornecedor</title>
                        ...
                        <div class="content-module-main cf">
                            ...
                            <table>
                                ...
                                <form action="" method="get" name="limit_go">
                                    Registros por pagina<input name="limit" type="text" class="round my_text_box" id="search_limit"
                                                          style="margin-left:5px;"
                                                          value="<?php if (isset($_GET['limit'])) echo $_GET['limit'];
                                                                        else echo "10"; ?>"
                                                          size="3" maxlength="3">
                                    <input name="go" type="button" value="Exbiri" class=" round blue my_button  text-upper"
                                ...
                                <form name="deletefiles" action="delete.php" method="post">
                                   ...
                                   <!-- <input type="button" name="selectall" value="SelectAll"
                                    ...
                                    <input type="button" name="unselectall" value="DeSelectAll"
                                           ...
                                           style="margin-left:5px;"/>-->
                                    <input name="dsubmit" type="button" value="Excluir Selecionados"
                                   ...
                                   style="margin-left:5px;" id="cancelall"/>-->
                                    ...
                                    <table>
                                        ...
                                        if ($lastpage > 1) {
                                            ...
                                            if ($page > 1)
                                                $pagination .= "<a href=\"view_supplier.php?page=$prev&limit=$limit\" class=my_pagination >Anterior</a>";
                                            else
                                                $pagination .= "<span class=my_pagination>Anterior</span>";
                                            ...
                                            if ($page < $counter - 1)
                                                $pagination .= "<a href=\"view_supplier.php?page=$next&limit=$limit\" class=my_pagination>Proximo</a>";
                                            else
                                                $pagination .= "<span class= my_pagination >Proximo</span>";
                                            ...
                                            <table>
                                                <tr>
                                                    <td align='right'style="width:20%"><?php $end = $no + $co1; ?>
                                                        <?php if($end != ''){ ?>
                                                        Exibindo <?php echo $no + 1; ?> a <?php echo $end; ?> de <?php echo $co; ?> registros</td><td >&nbsp;</td><td><?php echo $pagination; ?></td>
                                                    <?php }else{?>
                                                    Exibindo <?php echo $no; ?> a <?php echo $end; ?> de <?php echo $co; ?> registros</td><td >&nbsp;</td><td><?php echo $pagination; ?></td>
                                                    <?php } ?>
                                                </tr>
                                            </table> 
                                    </table>
