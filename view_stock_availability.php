                ...
                <div class="side-content fr">
                    ...
                    <div class="content-module">
                        ...
                        <div class="content-module-heading cf">
                            ...
                            <h3 class="fl">Disponibilidade em Estoque</h3>
                        ...
                        <div class="content-module-main cf">
                            ...
                            <table>
                                <form action="" method="post" name="search">
                                    <input name="searchtxt" type="text" class="round my_text_box" placeholder="Pesquisar" style="margin-left: 200px">
                                    &nbsp;&nbsp;<input name="Search" type="submit" class="my_button round blue   text-upper" value="Pesquisar">
                                </form>
