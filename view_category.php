                ...
                <div class="side-content fr">
                    ...
                    <div class="content-module">
                        ...
                        <div class="content-module-heading cf">
                            ...
                            <h3 class="fl">Categoria de Estoque/Produto</h3>
                            ...
                            <table>
                                ...
                                <form action="" method="get" name="limit_go">
                                    Registros por pagina<input name="limit" type="text" class="round my_text_box" id="search_limit"
                                                          ...
                                                          size="3" maxlength="3">
                                    <input name="go" type="button" value="Exibir" class=" round blue my_button  text-upper"
                                ...
                                <form name="deletefiles" action="delete.php" method="post">
                                    ...
                                    <table>
                                        ...
                                        if ($lastpage > 1) {
                                            ...
                                            if ($page > 1)
                                                $pagination .= "<a href=\"view_category.php?page=$prev&limit=$limit\" class=my_pagination >Anterior</a>";
                                            else
                                            ...
                                            if ($page < $counter - 1)
                                                $pagination .= "<a href=\"view_category.php?page=$next&limit=$limit\" class=my_pagination>Proximo</a>";
                                            else
