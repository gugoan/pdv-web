                            ...
                            if (isset($_POST['supplier']) and isset($_POST['stock_name'])) {
                                ...
                                foreach ($namet as $name1) {
                                    ...
                                    if ($count == 1) {
                                        ...
                                        echo "<br><font color=green size=+1 >There is no enough stock deliver for $name1! Please Adic. Estoque !</font>";
                                    }
                                ...
                                <table class="form" id="display" style="display:none">
                                    <tr>
                                        ...
                                        <td><input type="button" onclick="add_values()" onkeyup=" balance_amount();"
                                                   id="add_new_code"
                                                   style="margin-left:20px; width:30px;height:30px;border:none;background:url(images/Gravar.png)"
                                                   class="round"></td>
